        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              <div class="row">
                <div class="col-lg-5">
                  <h3><i class="fa fa-commenting-o" aria-hidden="true"></i>Retroalimentación continua</h3>
                  <?php
                  $idcampo="";
                  $retro="";
              ...
              <div class="row">
                <div class="col-lg-5 col-md-5">
                  <form method="post" action="<?php echo base_url(); ?>index.php/Panel_seguimiento/guardaretroAlimentacionContinua/<?php echo $idRetroAlimntacion; ?>">
                    ...
                    <center>
                      ...
                      if (isset($ExistenResultados)) {
                        ...
                        ?>
                        <button type="submit"  class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"></i> PUBLICAR Y SIGUIENTE</button>
                        <a class="btn btn-danger"  href='<?php echo base_url(); ?>index.php/Panel_seguimiento/retroalimentacionlista/<?php echo "".$idcampo; ?>'><i class="fa fa-times" aria-hidden="true"></i> TERMINAR</a>
                        <?php
                      }
                      ?>
