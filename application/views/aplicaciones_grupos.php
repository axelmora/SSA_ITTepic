                            ...
                            <center>
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/Panel_seguimiento/resultados/<?php echo $idseguimiento_encuesta."/".$IDGRUPO; ?>"><i class="fa fa-area-chart" aria-hidden="true"></i> RESULTADOS</a>
