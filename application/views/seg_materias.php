          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Elegir materias para ignorar." href="<?php echo base_url(); ?>index.php/Panel_seguimiento/materias_excluidas" role="button"><i class="fa fa-table" aria-hidden="true"></i> MATERIAS EXCLUIDAS.</a>
                <br>
                <br>
                <?php
                if ($MATERIAS) {
