<div class="sombranav">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" style="font-size:30px; color:#FF8000;" href="<?php echo base_url(); ?>"> SSA</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo "".base_url().'panel_administracion/mesadeayuda';?>"><i class="fa fa-question" aria-hidden="true"></i> MESA DE AYUDA</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo "".base_url().'panel_administracion/sistemainfo';?>"><i class="fa fa-server" aria-hidden="true"></i>INFORMACION SISTEMA</a>
        </li>
      </ul>
      <ul class='navbar-nav'>
