                              ...
                              <center>
                                <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/Panel_seguimiento/reporteIndividual/<?php echo "".$valor->idgrupos; ?>"><i class="fa fa-file-pdf-o aria-hidden="true"></i> REPORTE INDIVIDUAL</a>
