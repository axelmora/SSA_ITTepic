        ...
        <div class="panel panel-default Sombra">
          <div class="panel-heading">
            <div class="row">
              ...
              <div class="col-md-2">
                <center>
                  <img  class="img-responsive logotecenceusta" src="<?php echo base_url(); ?>/imagenes/escudo_itt_grande.png" height="150" width="150">
                </center>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <form role="form"  method="post" id="formularioencuestaprincipal" action="" >
                  <!-- DATOS  -->
                  <div>
                    <p class="textopreguntas">
                      <center>
                        <h4><i class="fa fa-list" aria-hidden="true"></i> <b> CUESTIONARIO  </b></h4>
                        <hr class="separador">
                      </center>
                    </p>
                    <p class="textopreguntas"></p>
                    <div class="row">
                      <div class="col-md-10 col-md-offset-1">
                        <div class="table-responsive">
                          <table class="table table-striped table-hover Sombra">
                            <tbody>
                              <tr>
                                <td class="Si_No" colspan="4" ><center> DATOS GENERALES </center></td>
                              </tr>
                              <tr>
                                <td class="Si_No" >Alumno</td>
                                <td> </td>
                                <td class="Si_No" >Numero de Control</td>
                                <td> </td>
                              </tr>
                              <tr>
                                <td class="Si_No"  colspan="1">Profesor:</td>
                                <td  colspan="3"> </td>
                              </tr>
                              <tr>
                                <td class="Si_No"  colspan="1" >Materia:</td>
                                <td  colspan="3"> </td>
                              </tr>
                              <tr>
                                <td class="Si_No"  colspan="1">Grupo:</td>
                                <td  colspan="3">  </td>
                              </tr>
                            </tbody>
                          </table>
                  ...
                  <div>
                    ...
                    <div class="row">
                      <div class="col-md-10 col-md-offset-1">
                        <table class="table table-striped table-hover Sombra">
                          <tbody>
                            <tr>
                              <td>&nbsp;</td>
                              <td class="Si_No" >Si</td>
                              <td class="Si_No">No</td>
                            </tr>
                            <tr>
                              <td>
                      ...
                      <div>
                        <br>
                        <p class="textopreguntas">2.- ¿Qué unidad estas cursando actualmente?
                          <select class="selectpicker" name="unidadcursando" id="unidadcursando" title="Elige una unidad." required>
