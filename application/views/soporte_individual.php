...
<body>
			...
			<div class="col-lg-12">
				<div class="card menus">
					<div class="card-body">
						...
						<a class="btn btn-naranja" data-toggle="tooltip" data-placement="top" title="Volver" href="<?php echo base_url(); ?>index.php/Panel_seguimiento/soporte_tecnico" role="button"><i class="fa fa-undo" aria-hidden="true"></i></a>
						<div class="container">
							<?php
							$idmensaje="";
							$estadovalor=0;
								...
								foreach ($asuntos as $filas => $valores) {
									...
									<div class="card  menus">
										<div class="card-body">
											...
											<p class="card-text"><b>Ventana Error:</b> <a target="_blank" href="<?php echo $valores->url_mensaje; ?>"> <?php echo $valores->url_mensaje; ?></a></p>
										</div>
									</div>
									<?php
								}
							...
							<div class="card" id="panelrespuesta">
								<div class="card-body">
									<form method="post" action="<?php echo base_url(); ?>index.php/Panel_seguimiento/respuesta/<?php echo $idmensaje; ?>">
										...
										<center>
											<button type="submit" class="btn btn-success"><i class="fa fa-share-square-o" aria-hidden="true"></i> RESPONDER</button>
										</center>
									</form>
								</div>
							</div>
	...
	if ($respuestas) {
		$pos=0;
		foreach ($respuestas as $filas => $valores2) {  ?>
			<form method="post" action="<?php echo base_url(); ?>index.php/Panel_seguimiento/borrarRespuesta/<?php echo $valores2->idrespuestas_mesa?>">
				<!-- Modal borrar -->
