          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                <div class="row">
                  <div class="col-lg-10">
                    <h4><i class="icon-clipboard" aria-hidden="true"></i>Docentes del departamento de <?php echo "".$this->session->userdata('departamentonombre'); ?> </h4>
                  </div>
                  <div class="col-lg-2">
                    <center>
                    </center>
                  ...
                  <div class="card bg-danger text-white animated fadeInUp">
                    <div class="card-body">
                      <center>
                        ...
                        Actualmente no se cuentan con docentes en este departamento.
                      </center>
                    </div>
                  </div>
                  <?php
