...
<body>
	...
	<div class="row" style="margin-right: 0px; margin-left: 0px; margin-top:1%;">
		<div class="col-lg-12">
			<div id="manualdeusuariover3"></div>
			<br>
			<center>
				<a href="<?php echo base_url();?>file/manual/Manual_Tecnico_SSA.pdf" class="btn btn-primary" download> <i class="fa fa-download" aria-hidden="true"></i>DESCARGAR MANUAL</a>
			</center>
		</div>
	</div>
