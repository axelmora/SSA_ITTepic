              ...
              <div class="col-lg-12">
                <div class="row">
                  <div class="col-lg-10">
                    ...
                    <a class="btn btn-naranja" data-toggle="tooltip" data-placement="top" title="Volver" href="<?php echo base_url(); ?>index.php/Panel_Administrativo/reportes" role="button"><i class="fa fa-undo" aria-hidden="true"></i></a>
                  </div>
                  <div class="col-lg-2">
                  </div>
                </div>
